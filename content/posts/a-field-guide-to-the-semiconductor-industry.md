...
<figure style="max-width:880px;margin:1.75rem 0;background:var(--color-surface);border:1px solid var(--color-border);border-radius:12px;padding:12px;">
  <img src="/static/semis/img/map-diagram.png" alt="The value-chain map: EDA and IP license into chip design, equipment and HBM feed in from above, wafers flow rightward to packaging, systems and cloud, with an amber loop showing hyperscalers designing their own chips" style="width:100%;border-radius:8px;box-shadow:0 6px 24px rgba(0,0,0,0.35);display:block;">
