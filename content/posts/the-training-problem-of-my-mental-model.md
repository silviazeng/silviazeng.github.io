---
title: The Training Problem of My Mental Model
date: 2021-02-17
tags:
  - career
  - AI
  - learning
  - reading
description: "I treated my own learning as a training problem, trading expressivity for simplicity."
---
...
According to wiki, overfitting is "the production of an analysis that corresponds too closely or exactly to a particular set of data, and may therefore fail to fit additional data or predict future observations reliably."

The first few months into my MBA, a question came to my mind: "why can people in such a top program be so irresponsible?" By that time, I had stayed in one company for too long, and I was under the impression that bringing the best results at all costs — even at the expense of your sleep — was something a good teammate _should_ do. So whenever a teammate delivered work that didn't meet my standard, I would categorize them as "unreliable people I don't want to work with." As you can imagine, very few classmates made it into the "reliable" bucket by the end of two years.
...
Underfitting occurs when a model cannot adequately fit the data — which harms accuracy just as much as overfitting does.
...
After going through both — overfitting and then underfitting — I came out with a better model of the working world than I started with. Late in my 30s, but better late than never.

To become better at processing information and solving problems, what we need is to continuously fine-tune our training set and our model — even when the feedback doesn't come as quickly or cleanly as in a controlled experiment. Find the sweet spot between overfitting and underfitting through iteration, and the generalist vs. specialist question starts to matter a lot less.